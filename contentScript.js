...
calculatePlaylistDuration = () => {
    const videosTimestamp = document.querySelectorAll(".timestamp span");
    let totalSeconds = 0;
    for (let i = 0; i < videosTimestamp.length; i++) {
        let videoLength = videosTimestamp[i].childNodes[0].nodeValue.split(":");
...
if (isPlaylistURL) {
    ...
    document.getElementsByClassName("pl-header-details")[0].appendChild(li);
}
